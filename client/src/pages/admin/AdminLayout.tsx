  ...
  return (
    <div className="h-screen overflow-hidden">
      ...
      <div className="flex flex-col h-full lg:flex-row gap-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
        {/* Admin Sidebar */}
        <aside className="w-full lg:w-64 shrink-0 h-fit bg-lime-50 rounded-lg p-4 border border-zinc-200">
          <div className="pb-4 mb-4 border-b border-zinc-200">
            <h2 className="text-lg font-semibold text-lime-950 flex items-center gap-2 px-2">
              <ShieldIcon className="size-5 text-lime-600" /> Admin Panel
            </h2>
          </div>
                ...
                className={({ isActive }) =>
                  `flex items-center gap-3 p-2.5 rounded-md text-sm transition-colors ${
                    isActive
                      ...
                      : "text-zinc-500 hover:bg-orange-100 hover:text-zinc-900"
                  }`
                }
              >
